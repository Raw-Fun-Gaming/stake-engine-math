## Expanding Wilds Lines + Super Spin mode
...
Super Spin mode, costing 25x. This mode is independent, with no free game entry.
...
1 Wild can initially appear on each reel. Symbol then expands out to fill all active rows. Expanded symbol is sticky and persistent for all remaining free game spins.
