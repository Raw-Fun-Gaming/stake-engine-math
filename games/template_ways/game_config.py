...
class GameConfig(Config):
    ...
    def __init__(self):
        ...
        self.free_spin_triggers = {
            self.base_game_type: {3: 10, 4: 15, 5: 20},
            self.free_game_type: {2: 4, 3: 6, 4: 8, 5: 10},
        }
        self.anticipation_triggers = {self.base_game_type: 2, self.free_game_type: 1}
        # Reels
        reels = {
            "base": "base.csv",
            "free": "free.csv",
            "free_wincap": "free_wincap.csv",
        }
        self.reels = {}
                    ...
                    Distribution(
                        ...
                        conditions={
                            "reel_weights": {
                                ...
                                self.free_game_type: {"free": 1, "free_wincap": 5},
                            },
                            "force_wincap": True,
                            "force_free_game": True,
                            "scatter_triggers": {3: 100, 4: 20, 5: 5},
                            "multiplier_values": {1: 20, 2: 50, 3: 80, 4: 100, 5: 20},
                        },
                    ),
                    Distribution(
                        criteria="free_game",
                        ...
                        conditions={
                            ...
                            "force_free_game": True,
                            "scatter_triggers": {3: 100, 4: 20, 5: 5},
                            "multiplier_values": {1: 200, 2: 100, 3: 80, 4: 50, 5: 20},
                        },
                    ),
                    Distribution(
                        criteria="0",
                ...
                distributions=[
                    Distribution(
                        ...
                        conditions={
                            ...
                            "force_free_game": True,
                            "scatter_triggers": {3: 100, 4: 20, 5: 5},
                            "multiplier_values": {1: 20, 2: 100, 3: 80, 4: 90, 5: 80},
                        },
                    ),
                ],
            ),
