"""Game state for 0_0_cluster - Cluster-pay slot with tumble mechanics and grid multipliers.
...
class GameState(Tumble):
    ...
    def update_freespin(self) -> None:
        ...
        Extends base update_freespin with custom counter increment order.
        """
        self.fs += 1
